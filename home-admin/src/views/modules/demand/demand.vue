<template>
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item label="意向楼盘" prop="region">
        <el-input v-model="dataForm.intentions" placeholder="意向楼盘" clearable></el-input>
      </el-form-item>
      <el-form-item>
...
<script>
  import AddOrUpdate from './demand-add-or-update'
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/sys/api/getDemandList'),
          method: 'get',
          params: this.$http.adornParams({
            ...
            'intentions': this.dataForm.intentions,
