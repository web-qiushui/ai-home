<template>
  ...
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.name" placeholder="字典名" clearable></el-input>
      </el-form-item>
      <el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      addOrUpdateHandle (id) {
        ...
        this.$nextTick(() => {
          this.$refs.addOrUpdate.init(id, this.dataForm.n1)
        })
      },
      // 删除
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/sys/datadict/deleteDatadict'),
            method: 'get',
            params: {
              ids: ids
            }
