<template>
    <view class="uni-load-more" @click="onClick">
        ...
        <!-- #endif -->
        <!-- #ifdef APP-NVUE || H5 -->
        <text class="uni-load-more__text" :style="{color: color}">{{ status === 'more' ? contentText.contentdown :
            status === 'loading' ? contentText.contentrefresh : contentText.contentnomore }}
        </text>
        <!-- #endif -->
        <!-- #ifndef APP-NVUE || H5 -->
        <text class="uni-load-more__text">{{ status === 'more' ? contentText.contentdown : status === 'loading' ?
            contentText.contentrefresh : contentText.contentnomore }}
        </text>
        <!-- #endif -->
    </view>
</template>
