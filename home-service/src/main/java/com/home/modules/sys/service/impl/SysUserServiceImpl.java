...
import com.home.modules.sys.dao.SysUserDao;
import com.home.modules.sys.entity.SysUserEntity;
import com.home.modules.sys.service.SysRoleService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
	...
	public PageUtils queryPage(Map<String, Object> params) {
		...
		if (params.get("role") != null) {
			...
			userIds = sysUserRoleService.queryUserIdList(Long.parseLong(role));
		}
		...
		IPage<SysUserEntity> page = this.page(
			new Query<SysUserEntity>().getPage(params), queryWrapper);
	...
	@Override
	public SysUserEntity queryByAppUserId(Integer appUserId) {
		LambdaQueryWrapper<SysUserEntity> queryWrapper = Wrappers.<SysUserEntity>lambdaQuery()
				.eq(SysUserEntity::getAppUserId, appUserId)
				.last(" LIMIT 1");
	...
	@Override
	public List<BeanVO> queryByRole(Integer role) {
		return baseMapper.queryByRole(role);
	}
