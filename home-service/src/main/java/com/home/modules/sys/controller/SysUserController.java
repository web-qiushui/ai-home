...
import com.home.common.validator.group.AddGroup;
import com.home.common.validator.group.UpdateGroup;
import com.home.modules.sys.entity.SysUserEntity;
import com.home.modules.sys.form.PasswordForm;
...
public class SysUserController extends AbstractController {
	...
	public R list(@RequestParam Map<String, Object> params){
		...
		if (!roleIdList.contains(Constant.Role.SYSTEM) && !roleIdList.contains(Constant.Role.ADMIN_SYSTEM)) {
	...
	public R info(){
		...
		List<Long> roles = sysUserRoleService.queryRoleIdList(userEntity.getUserId());
		userEntity.setRoleIdList(roles);
	 ...
	 */
	@GetMapping("/getInfo")
	public JsonResult<SysUserEntity> getInfo(){
		SysUserEntity userEntity = getUser();
		userEntity.setPassword(null);
